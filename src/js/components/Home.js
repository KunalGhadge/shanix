            ...
            <div className="home_content">
                <div className="left_side">
                    ...
                    <div className="home_main">
                        ...
                        <TextSplit className="text_h1">I'm SHANIX!,</TextSplit>
                        <TextSplit className="text_h1">India's First Phonk producer. </TextSplit>
                        <span className="tag_h1">&lt;h1/&gt;</span> <br />
                        <h2 className="h2_greating">India's First Phonk Producer / Ethical Hacker / Game Dev</h2>
                ...
                <div className="right_side">
                    ...
                    <svg className="logo" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 300">
                        <text className="path" xmlSpace="preserve" textAnchor="middle"
                            y="200" x="500">SHANIX!
                        </text>
                    </svg>
                    <svg className="logo_mirror" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 300">
                        <text className="path" xmlSpace="preserve" textAnchor="middle"
                            fontSize="250" y="200" x="500">SHANIX!
                        </text>
                    </svg>
                </div>
            </div>
